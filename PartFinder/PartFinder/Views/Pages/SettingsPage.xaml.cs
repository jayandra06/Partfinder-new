...
public sealed partial class SettingsPage : Page
{
    ...
    public SettingsPage() : this(App.Services.GetRequiredService<SettingsViewModel>())
    {
    }
    ...
    public SettingsPage(SettingsViewModel vm)
    {
        ...
        System.Diagnostics.Debug.WriteLine($"[SettingsPage] DataContext Type: {DataContext?.GetType().Name}");
        System.Diagnostics.Debug.WriteLine($"[SettingsPage] VM Instance: {vm.GetHashCode()}");
    }
    ...
    private void OnNavProfileClick(object sender, RoutedEventArgs e) =>
        ShowSection(profile: true, security: false, password: false, appLock: false, loginDevice: false);

    private void OnNavSecurityClick(object sender, RoutedEventArgs e) =>
        ShowSection(profile: false, security: true, password: false, appLock: false, loginDevice: false);

    private void OnNavPasswordClick(object sender, RoutedEventArgs e) =>
        ShowSection(profile: false, security: false, password: true, appLock: false, loginDevice: false);

    private void OnNavAppLockClick(object sender, RoutedEventArgs e) =>
        ShowSection(profile: false, security: false, password: false, appLock: true, loginDevice: false);

    private void OnNavLoginDeviceClick(object sender, RoutedEventArgs e) =>
        ShowSection(profile: false, security: false, password: false, appLock: false, loginDevice: true);
    ...
    private void ShowSection(bool profile, bool security, bool password, bool appLock, bool loginDevice)
    {
        // Sections
        ...
        LoginDeviceSection.Visibility = loginDevice ? Visibility.Visible : Visibility.Collapsed;
        ...
        SetNavSelected(NavLoginDeviceItem, loginDevice);
    }
    ...
    protected override void OnNavigatedTo(Microsoft.UI.Xaml.Navigation.NavigationEventArgs e)
    {
        ...
        if (DataContext is SettingsViewModel vm)
        {
            ...
            // Ensure login session data is fresh
            _ = vm.LoadLoginSessionAsync();
        }
    }
    ...
    private void OnSettingsVmPropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
    {
        ...
        // Detect error status from ViewModel
        var isError = vm.ChangePasswordIsError;
        ...
        // Reset reveal modes on message change for security
        CurrentPasswordBox.PasswordRevealMode = PasswordRevealMode.Hidden;
        CurrentPasswordRevealIcon.Glyph = "\uE890";
        NewPasswordBox.PasswordRevealMode = PasswordRevealMode.Hidden;
        NewPasswordRevealIcon.Glyph = "\uE890";
